# MRA_figures_script.R
# Author: Armando Licata
# Date: 12/09/2025
# Purposes:
# - An R script to reproduce all figures presented in the manuscript.

##############################load dependencies
require(phyloseq) #v1.46.0
require(tidyverse) #v2.0
require(tidyr) #v1.3
require(purrr) #v1.0.2
require(microbiomeMarker) #v1.4.0
require(ggpubr) #0.6.1
######################
#Analysis on raw data#
######################


url1<-"https://github.com/DeCeccoLAB/QIIME2-MultiRegion-Microbiome-Pipeline/raw/refs/heads/main/R_scripts/otu_raw_gen.rds"
download.file(url1, destfile = "./otu_raw_gen.rds",cacheOK=TRUE) 
otu_raw_gen<-readRDS("./otu_raw_gen.rds")

url2<-"https://github.com/DeCeccoLAB/QIIME2-MultiRegion-Microbiome-Pipeline/raw/refs/heads/main/R_scripts/metadata_total.rds"
download.file(url2, destfile = "./metadata_total.rds",cacheOK=TRUE) 
metadata_total<-readRDS("./metadata_total.rds")
